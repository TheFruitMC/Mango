...
public final class SkinnedEntityInstanceCollector implements AutoCloseable {
    ...
    public static final int BONE_PALETTE_OFFSET_FIELD = TINT_OFFSET + INT_BYTES;
    public static final int BYTES_PER_INSTANCE = BONE_PALETTE_OFFSET_FIELD + INT_BYTES;
    ...
    public SkinnedEntityInstanceCollector() {
    ...
    public int addInstance(
        ...
        if (!recordUnchanged) {
            ...
            this.buffer.putInt(base + BONE_PALETTE_OFFSET_FIELD, bonePaletteOffset);
        }
    ...
    public void removeLastInstance() {
        if (this.instanceCount == 0) {
            throw new IllegalStateException("Cannot roll back an empty skinned entity instance collector");
        }
        this.instanceCount--;
    }
    ...
    private boolean sameRecord(
        ...
        return this.buffer.getInt(base + COLUMN_0_OFFSET) == Float.floatToRawIntBits(modelMatrix.m00())
            ...
            && this.buffer.getInt(base + BONE_PALETTE_OFFSET_FIELD) == bonePaletteOffset;
    }
